...
const Navbar = () => {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row justify-between shadow-2xl bg-slate-200 sm:h-20 h-auto p-2">
          ...
          {user &&(
            <>
              <Link to="/" className="flex flex-col items-center">
                <AiFillHome className="text-gray-600  text-2xl sm:text-2xl" />
                <h3 className="text-gray-600 font-bold text-xs sm:text-sm hidden sm:block">
                  Home
                </h3>
              </Link>
              <Link to="/alluser" className="flex flex-col items-center ">
                <FaUserGroup className="text-gray-600 sm:text-2xl text-2xl" />
                <h3 className="text-gray-600 font-bold text-xs sm:text-sm hidden sm:block">
                  person
                </h3>
              </Link>
              <Link to="/listjob" className="flex flex-col items-center">
                <MdWork className="text-gray-600 sm:text-2xl text-2xl" />
                <h3 className="text-gray-600 font-bold text-xs sm:text-sm hidden sm:block">
                  job
                </h3>
              </Link>
              <div className="flex flex-col items-center">
                <FaFacebookMessenger className="text-gray-600 sm:text-2xl text-2xl" />
                <h3 className="text-gray-600 font-bold text-xs sm:text-sm hidden sm:block">
                  message
                </h3>
              </div>
              <div className="flex flex-col items-center">
                <IoMdNotifications className="text-gray-600 sm:text-2xl text-2xl" />
                <h3 className="text-gray-600 font-bold text-xs sm:text-sm hidden sm:block">
                  notifications
                </h3>
              </div>
              ...
              >
                <CgProfile className="text-gray-600 sm:text-2xl text-2xl" />
                <button className="text-gray-600 font-bold text-xs sm:text-sm hidden sm:block">
                  profile
                </button>
              </div>
            </>
